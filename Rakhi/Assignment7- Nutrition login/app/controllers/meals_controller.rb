class MealsController < ApplicationController
  ...
  def create
    ...
    #  @meal.units     = hash[:units]
      ...
      if @meal.save
        redirect_to meals_path, notice: "food successfully added."
      else
        redirect_to meals_path, alert: "Error adding food..."
      end
    end
  end
  ...
  def destroy
    ...
    redirect_to meals_path, notice: "Food successfully removed."
  end
