...
class BookTablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_table" do
    assert_difference('BookTable.count') do
      post book_tables_url, params: { book_table: { Book_name: @book_table.Book_name, Published_year: @book_table.Published_year } }
    end
  ...
  test "should update book_table" do
    patch book_table_url(@book_table), params: { book_table: { Book_name: @book_table.Book_name, Published_year: @book_table.Published_year } }
