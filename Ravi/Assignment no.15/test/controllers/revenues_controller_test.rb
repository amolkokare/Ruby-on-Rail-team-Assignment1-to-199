...
class RevenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create revenue" do
    assert_difference('Revenue.count') do
      post revenues_url, params: { revenue: { item: @revenue.item, quantity: @revenue.quantity, totalsales: @revenue.totalsales } }
    end
  ...
  test "should update revenue" do
    patch revenue_url(@revenue), params: { revenue: { item: @revenue.item, quantity: @revenue.quantity, totalsales: @revenue.totalsales } }
